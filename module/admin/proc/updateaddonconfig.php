...
function proc($data) {
	...
	try {
		...
		$remove_array = ['ao_id', 'ao_use_pc', 'ao_use_mobile', 'module', 'act', 'success_return_url', 'error_return_url'];
		...
		if(strlen($extra) > 65535) {
			throw new Exception(getLang(getLang('msg_max_overflow'), 65535), 1401);
		}
