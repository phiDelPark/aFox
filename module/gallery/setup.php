...
<?php $thumb_exists = !(empty($_GET['sub_id']) || !is_dir(_AF_ATTACH_DATA_.'thumbnail/'.$_GET['sub_id'].'/')); ?>
	<div class="mb-4">
		...
		<input class="form-check-input mx-1" type="checkbox" id="thumbOption" name="thumb_option" <?php echo $thumb_exists ? 'disabled="disabled" ' : ''?>value="1"<?php echo $GALLERY['thumb_option']==='1'?' checked':'' ?>>
