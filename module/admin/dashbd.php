					...
					<?php
						...
						if(empty($_list['error'])){
							foreach ($_list['data'] as $val) {
								echo '<a href="#" class="list-group-item"><span class="badge">'.timePassed($val['wr_regdate']).'</span>'.cutstr(strip_tags($val['wr_title']),50).'</a>';
							}
						}
					?>
				</div>
			...
			<div class="panel-body">
				<div class="list-group">
					<?php
						...
						if(empty($_list['error'])){
							foreach ($_list['data'] as $val) {
								echo '<a href="#" class="list-group-item"><span class="badge">'.timePassed($val['rp_regdate']).'</span>'.cutstr(strip_tags($val['rp_content']),50).'</a>';
							}
						}
					?>
				</div>
