	  ...
	  <ul class="navbar-nav">
		<li class="nav-item dropdown">
		  ...
		  <ul class="dropdown-menu dropdown-menu-end">
		 	<li><a class="dropdown-item" href="<?php echo getUrl('', 'admin', 'clearcache')?>"><svg class="bi" aria-hidden="true"><use href="<?php echo _AF_URL_?>module/admin/bi-icons.svg#recycle"/></svg> <?php echo getLang('clear_cache') ?></a></li>
