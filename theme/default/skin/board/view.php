...
<?php if(!empty($DOC['wr_tags'])) {
	...
	foreach ($hashtags as $val) {
		echo '<a class="icon-link icon-link-hover gap-0 me-2" href="'.getUrl('','id',__MID__,'search','tag:'.$val).'"><svg class="bi"><use href="./theme/default/bi-icons.svg#hash"></use></svg>'.$val.'</a>';
	}
	echo '</div>';
} ?>
