...
<form id="loginForm" method="post" autocomplete="off" role="form" exec-ajax="member.loginCheck">
<input type="hidden" name="success_return_url" value="<?php echo getUrl()?>">
	<div class="w-50">
		<h3><i class="glyphicon glyphicon-user" aria-hidden="true"></i> <?php echo getLang('login')?></h3>
