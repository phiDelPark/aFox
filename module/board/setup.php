...
<?php $thumb_exists = !(empty($_GET['bo_id']) || !is_dir(_AF_ATTACH_DATA_.'thumbnail/'.$_GET['bo_id'].'/')); ?>
	<div class="mb-4">
		...
		<input class="form-check-input mx-1<?php echo $thumb_exists ? ' disabled' : ''?>" type="checkbox" id="thumbOption" name="thumb_option" value="1"<?php echo $BOARD['thumb_option']==='1'?' checked':'' ?>>
