...
// 트리거 확인및 설치
if(DB::count(_AF_TRIGGER_TABLE_,['tg_key'=>'M','tg_id'=>'board','use_pc'=>1,'use_mobile'=>1,'grant_access'=>0])!==1){
	DB::delete(_AF_TRIGGER_TABLE_,['tg_id'=>'board']);
	DB::insert(_AF_TRIGGER_TABLE_,['tg_key'=>'M','tg_id'=>'board','use_pc'=>1,'use_mobile'=>1,'grant_access'=>0]);
}
